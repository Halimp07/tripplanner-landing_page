          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            >
              ...
              <div className="flex justify-center items-center">
                <p className="md:text-5xl sm:text-4xl text-xl font-medium py-4">
                  Easy, and Itinerary Use
                  {/* Use typed for back and forth text */}
                </p>
                <Typed
                  className="bg-clip-text text-transparent bg-gradient-to-r from-[#1C3131] to-teal-400 md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2"
                  strings={["Plan", "Healing", "Refreshing"]}
                  typespeed={120}
                  backSpeed={140}
                  loop
                />
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                Plan your tour trip by scheduling
              </p>
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <span className="ml-3">Watch the full video (40 s)</span>
              </button>
            </div>
